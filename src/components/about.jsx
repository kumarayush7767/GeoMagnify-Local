                ...
                <div className='col-lg-6 col-sm-6 col-xs-12'>
                  <ul>
                    {/* {props.data
                      ...
                      <li><NavLink to="/multichannel" className="about-link">Multi Channel Analysis of Surface waves (MAWS)</NavLink></li>
                      <li><NavLink to="/seismic" className="about-link">Seismic Refraction</NavLink></li>
                      <li><NavLink to="/downhole" className="about-link" >Downhole Seismic</NavLink></li>
                  </ul>
                </div>
                <div className='col-lg-6 col-sm-6 col-xs-12'>
                  <ul>
                    {/* {props.data
                      ...
                      <li><NavLink to="/crosshole" className="about-link">Crosshole Seismic</NavLink></li>
                  </ul>
                </div>
              </div>
            </div>
